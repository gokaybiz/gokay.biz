...
const fetchLatestPosts = (count: number) =>
    Effect.tryPromise({
        try: () =>
            createPostQuery(count).all() as Promise<PostsCollectionItem[]>,
        catch: (error: unknown) =>
...
<template>
    <div class="max-w-6xl mx-auto pt-10 doodle">
        ...
        <div class="mb-12 text-center">
            ...
            >
                I'm
                <span class="text-orange-500 dark:text-orange-300 italic"
                    >Gökay</span
                >.
            </h2>
            <p
                class="text-3xl font-caveat text-gray-700 dark:text-gray-300 mb-4"
            >
